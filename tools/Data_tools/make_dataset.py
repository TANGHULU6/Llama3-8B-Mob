...
config = {
    "data_config": {
        "input_filepath": "data/cityA_groundtruthdata.csv.gz",  # Replace with your actual file path
        "output_filepath": "datasets/datasetsA.json",  # Replace with your actual file path
